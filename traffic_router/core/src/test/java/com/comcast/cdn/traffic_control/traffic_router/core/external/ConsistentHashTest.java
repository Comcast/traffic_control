...
public class ConsistentHashTest {
	...
	public void before() throws Exception {
		...
		Iterator<JsonNode> iterator = steeringNode.get("steeredDeliveryServices").iterator();
		while (iterator.hasNext()) {
			JsonNode steeredDeliveryService = iterator.next();
			steeredDeliveryServices.add(steeredDeliveryService.get("id").asText());
		}
