...
public class HTTPAccessEventBuilderTest {
    ...
    public void itGeneratesAccessEvents() throws Exception {
        ...
        assertThat(httpAccessEvent, equalTo("144140678.000 qtype=HTTP chi=192.168.7.6 url=\"http://example.com/index.html?foo=bar\" cqhm=GET cqhv=HTTP/1.1 rtype=- rerr=\"-\" rurl=\"-\""));
    }
    ...
    public void itAddsResponseData() throws Exception {
        ...
        assertThat(httpAccessEvent, equalTo("144140678.000 qtype=HTTP chi=192.168.7.6 url=\"http://example.com/index.html?foo=bar\" cqhm=GET cqhv=HTTP/1.1 rtype=CZ rerr=\"-\" pssc=302 ttms=125 rurl=\"http://example.com/hereitis/index.html?foo=bar\""));
    }
    ...
    public void itMarksTTMSLessThanMilliAsZero() throws Exception {
        ...
        assertThat(httpAccessEvent, equalTo("144140678.000 qtype=HTTP chi=192.168.7.6 url=\"http://example.com/index.html?foo=bar\" cqhm=GET cqhv=HTTP/1.1 rtype=ERROR rerr=\"-\" pssc=302 ttms=0 rurl=\"http://example.com/hereitis/index.html?foo=bar\""));
    }
    ...
    public void itRecordsTrafficRouterErrors() throws Exception {
        ...
        assertThat(httpAccessEvent, equalTo("144140678.000 qtype=HTTP chi=192.168.7.6 url=\"http://example.com/index.html?foo=bar\" cqhm=GET cqhv=HTTP/1.1 rtype=ERROR rerr=\"RuntimeException: you're doing it wrong\" pssc=302 ttms=0 rurl=\"http://example.com/hereitis/index.html?foo=bar\""));
    }
    ...
    public void itRecordsMissResultDetails() throws Exception {
        ...
        assertThat(httpAccessEvent, equalTo("144140678.000 qtype=HTTP chi=192.168.7.6 url=\"http://example.com/index.html?foo=bar\" cqhm=GET cqhv=HTTP/1.1 rtype=MISS.DS_NO_BYPASS rerr=\"-\" pssc=503 ttms=0 rurl=\"-\""));
    }
}
