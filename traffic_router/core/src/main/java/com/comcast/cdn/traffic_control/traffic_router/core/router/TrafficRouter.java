...
public class TrafficRouter {
	...
	public DeliveryService consistentHashDeliveryService(final DeliveryService deliveryService, final String requestPath) {
		...
		final String bypassDeliveryServiceId = steeringRegistry.get(deliveryService.getId()).getBypassDestination(requestPath);
		...
		final Hashable hashable = consistentHasher.selectHashable(deliveryService.getSteeringHashables(), requestPath, false);
		return cacheRegister.getDeliveryService(deliveryService.getSteeredId(hashable));
	}
