...
public class FederationsWatcher extends AbstractServiceUpdater {
    ...
    public void configure(final JSONObject config) {
        ...
        try {
            ...
            LOGGER.warn("Failed to update URL for TrafficOps authorization, check the api.auth.url, and the TrafficOps username and password configuration setting: " + e.getMessage());
